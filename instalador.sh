...
dependencias() {
  ...
  #SI ES MAYOR O IGUAL A 23.04 SOLO INSTALARA PYTHON 3
    ...
    soft="sudo bsdmainutils zip unzip ufw curl python3 python3-pip openssl screen cron iptables lsof pv boxes nano at mlocate gawk grep bc jq curl npm nodejs socat netcat netcat-traditional net-tools cowsay figlet lolcat apache2 cmatrix"
  #SI NO SE CUMPLEN LAS CONDICIONES DE ARRIBA SE EJECUTARA ESTA SECUENCIA
  else

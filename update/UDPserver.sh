...
download_udpServer(){
  ...
  msg -bar
  msg -ama "\e[93m         INSTALADOR UDPserver |\e[91m@rufu99| @Lacasitamx"
  ...
  3)stop_udp;;
  4)remove;;
  5) wget -O /etc/VPS-MX/protocolos/UDPserver.sh https://www.dropbox.com/s/tztehjw873f8nqf/UDPserver.sh &>/dev/null && chmod 777 /etc/VPS-MX/protocolos/UDPserver.sh && msg -verd "	UDPserver ACTUALIZADO" ;;
  0);;
  esac  
